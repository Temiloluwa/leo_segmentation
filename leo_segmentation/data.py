# pascal-voc dataset and augmented images obtained from ca-net paper implementation 
...
class Pascal5iDatagenerator(Dataset):
    ...
    def __init__(self, dataset, mode="meta_train"):
        ...
        self.transform_image =  Pascal5iTransformImage(img_dims.width, img_dims.height)
        self.transform_mask = Pascal5iTransformMask(img_dims.width, img_dims.height)
...
class Pascal5iFoldsTransformImage:
    """Performs data preprocessing steps on input images
...
class Pascal5iFoldsTransformMask:
    """Performs data preprocessing steps on input masks
...
class Pascal5iFoldsDatagenerator(Dataset):
    ...
    def __init__(self, dataset, mode):
        self._dataset = dataset
        self._data_type = mode
        self.classes_dict = meta_classes_selector(config, dataset)
        img_dims = config.data_params.img_dims
        self.transform_image = Pascal5iFoldsTransformImage(img_dims.width, img_dims.height)
        self.transform_mask = Pascal5iFoldsTransformMask(img_dims.width, img_dims.height)
...
if config.selected_data == "pascal_5i":
    Datagenerator = Pascal5iDatagenerator
else:
    Datagenerator = Pascal5iFoldsDatagenerator